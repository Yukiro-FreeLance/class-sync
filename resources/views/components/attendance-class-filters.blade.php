...
<div @class([
    ...
    'lg:grid-cols-5' => $showSchedule && !$showStrandFilter,
    'lg:grid-cols-6' => $showSchedule && $showStrandFilter,
    'lg:grid-cols-4' => !$showSchedule && !$showStrandFilter,
    'lg:grid-cols-5' => !$showSchedule && $showStrandFilter,
])>
    <div>
        @if ($labeled)
    ...
    @if ($showStrandFilter)
        <div>
            ...
            @endif
            <select wire:model.live="strand" class="select-field" {{ $gradeId ? '' : 'disabled' }}>
