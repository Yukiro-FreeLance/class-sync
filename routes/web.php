...
Route::middleware(['installed', 'auth'])->group(function () {
    Route::get('/subscription-expired', function (SubscriptionService $subscription, BrandingService $branding) {
    ...
    Route::middleware(['subscription.active'])->group(function () {
        ...
        Route::prefix('settings')->name('settings.')->group(function () {
            ...
            Route::get('/subscription', SettingsSubscription::class)->name('subscription');
